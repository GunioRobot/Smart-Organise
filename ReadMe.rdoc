...
Navigate to the Automator Actions folder.  For each of the .action files, double click to open, and click Install when prompted.  If you are prompted to replace the action, click Replace (if you you click Cancel the new version of the action will not be installed).
