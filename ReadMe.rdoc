...
URL::     dimensionsunmarked.com
COPYRIGHT::	(c) 2009-2010 Mannie Tagarira
LICENCE::	LGPL 3 (See COPYING or http://www.gnu.org/licenses/lgpl.html)
...
- Updated automator actions to allow for enabling and disabling of Growl notifications.
- Fixes for crashes in Mac OS X 10.5 (Leopard).
